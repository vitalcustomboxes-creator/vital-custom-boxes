        ...
        headers: [
          ...
          // Images allow https (CDN + /_next/image); no third-party JS loads.
          {
            ...
            value: [
              ...
              `script-src 'self' 'unsafe-inline' blob: https://apis.google.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://embed.tawk.to${process.env.NODE_ENV !== 'production' ? " 'unsafe-eval'" : ""}`,
              `connect-src 'self' https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firestore.googleapis.com https://apis.google.com https://www.google-analytics.com https://www.googletagmanager.com https://www.google.com https://www.google.com.pk https://www.googleadservices.com https://googleads.g.doubleclick.net https://ad.doubleclick.net https://*.tawk.to wss://*.tawk.to${process.env.NODE_ENV !== 'production' ? " ws: wss:" : ""}`,
              "manifest-src 'self'",
